# Enhanced auth service with RLS context setting
import os
import json
...
class SecureAuthService:
    """Enhanced authentication service with RLS support"""
    
    @staticmethod
    def set_rls_context(user_id: str):
    ...
    async def register_user(user_data: UserRegistration) -> Dict[str, Any]:
        ...
        try:
            ...
            hashed_password = SecureAuthService.get_password_hash(user_data.password)
            ...
            if result.data:
                ...
                access_token = SecureAuthService.create_access_token(data={"sub": user_id})
                return {
                    "user_id": user_id,
    ...
    async def authenticate_user(email: str, password: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Verify password
            if not SecureAuthService.verify_password(password, user["hashed_password"]):
                return None
            
            # Set RLS context for this user
            SecureAuthService.set_rls_context(user["id"])
    ...
    async def get_user_profile(user_id: str) -> Optional[UserProfile]:
        ...
        try:
            ...
            # Set RLS context for this user
            SecureAuthService.set_rls_context(user_id)
